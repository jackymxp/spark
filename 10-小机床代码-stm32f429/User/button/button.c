...
static void Draw_Spindle_Btn(void* btn)
{
...
static void Spindle_Command(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;	
	//主轴开
	if((ptr->touch_num & 0x01)  )
...
static void Draw_Coolant_Btn(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
static void Coolant_Command(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
	//水泵开
...
static void Draw_StepMotor_Up_Btn(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
static void StepMotor_Up_Command(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
static void Draw_StepMotor_Down_Btn(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
static void StepMotor_Down_Command(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
//停止按钮
static void Draw_Stop_Btn(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
...
static void Stop_Command(void* btn)
{
	Touch_Button *ptr = (Touch_Button *)btn;
	//开始加工
	if((ptr->touch_num & 0x01)  )
