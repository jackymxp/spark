...
#define GPIOA               ((GPIO_TypeDef *) GPIOA_BASE)  //GPIOA->CRL = 0x0x0x0x0x0x0x0; //地址
#define GPIOB               ((GPIO_TypeDef *) GPIOB_BASE)  //GPIOA.CRL = 0X0X0X0X0X0X0X0; // 数据
#define GPIOC               ((GPIO_TypeDef *) GPIOC_BASE) //(*GPIOA).CRL = IIHIOHFDIOHSIDHSI //地址
